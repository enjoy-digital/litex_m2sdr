...
# SI5251 config (148.5MHz on CLK0 from 27MHz XO) ---------------------------------------------------

def i2c_program_148p5(sys_clk_freq):
    i2c_sequence = [
        [(0x60 << 1),   0x03, 0xff],
        [(0x60 << 1),   0x10, 0x80],
        [(0x60 << 1),   0x11, 0x80],
...
# SI5251 config (148.35MHz on CLK0 from 27MHz XO) --------------------------------------------------

def i2c_program_148p35(sys_clk_freq):
    i2c_sequence = [
        [(0x60 << 1), 0x03, 0xff],
        [(0x60 << 1), 0x10, 0x80],
        [(0x60 << 1), 0x11, 0x80],
