...
from litex_m2sdr.gateware.ad9361.scheduler_opti import Scheduler
...
class Top(Module):
    def __init__(self):
        ...
        self.submodules.sched = Scheduler(frames_per_packet=1024, data_width=64, max_packets=4)
        ...
        self.meetadata_fifo = self.sched.metadata_fifo
...
def stimulus(dut):
    ...
    yield from drive_packet(dut, ts1, data_size_1)
    ...
    ts2 = data_size_1 + wait + 2 * 1024
    data_size_2 = 1024 * 1
    yield from drive_packet(dut, ts2, data_size_2)
