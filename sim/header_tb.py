...
from litex_m2sdr.gateware.header import TXHeaderExtracter
...
class Top(Module):
    def __init__(self):
        ...
        self.submodules.header = TXRXHeader(data_width=64, with_csr=False)
        self.submodules.scheduler = Scheduler(packet_size=8176, data_width=64, max_packets=4)
        
        self.comb += self.header.tx.source.connect(self.ad9361.sink),
        ...
        # Shorthand handles
        self.sink   = self.header_tx.sink
        self.source = self.header_tx.source
