...
class BaseSoC(SoCMini):
    def __init__(self, sys_clk_freq=int(125e6), with_pcie=True, pcie_lanes=1, with_jtagbone=True):
        ...
        self.si5351_clk0_measurement = ClkMeasurement(clk=Signal())
        self.si5351_clk1_measurement = ClkMeasurement(clk=Signal())
        self.si5351_clk2_measurement = ClkMeasurement(clk=Signal())
        self.si5351_clk3_measurement = ClkMeasurement(clk=Signal())
