...
#define CSR_AD9361_SCHEDULER_TX_CURRENT_TS_ADDR (CSR_BASE + 0xc038L)
#define CSR_AD9361_SCHEDULER_TX_CURRENT_TS_SIZE 2
#define CSR_AD9361_SCHEDULER_TX_NOW_ADDR (CSR_BASE + 0xc040L)
#define CSR_AD9361_SCHEDULER_TX_NOW_SIZE 2
#define CSR_AD9361_PRBS_TX_ADDR (CSR_BASE + 0xc048L)
#define CSR_AD9361_PRBS_TX_SIZE 1
#define CSR_AD9361_PRBS_RX_ADDR (CSR_BASE + 0xc04cL)
#define CSR_AD9361_PRBS_RX_SIZE 1
#define CSR_AD9361_AGC_COUNT_RX1_LOW_CONTROL_ADDR (CSR_BASE + 0xc050L)
#define CSR_AD9361_AGC_COUNT_RX1_LOW_CONTROL_SIZE 1
#define CSR_AD9361_AGC_COUNT_RX1_LOW_STATUS_ADDR (CSR_BASE + 0xc054L)
#define CSR_AD9361_AGC_COUNT_RX1_LOW_STATUS_SIZE 1
#define CSR_AD9361_AGC_COUNT_RX1_HIGH_CONTROL_ADDR (CSR_BASE + 0xc058L)
#define CSR_AD9361_AGC_COUNT_RX1_HIGH_CONTROL_SIZE 1
#define CSR_AD9361_AGC_COUNT_RX1_HIGH_STATUS_ADDR (CSR_BASE + 0xc05cL)
#define CSR_AD9361_AGC_COUNT_RX1_HIGH_STATUS_SIZE 1
#define CSR_AD9361_AGC_COUNT_RX2_LOW_CONTROL_ADDR (CSR_BASE + 0xc060L)
#define CSR_AD9361_AGC_COUNT_RX2_LOW_CONTROL_SIZE 1
#define CSR_AD9361_AGC_COUNT_RX2_LOW_STATUS_ADDR (CSR_BASE + 0xc064L)
#define CSR_AD9361_AGC_COUNT_RX2_LOW_STATUS_SIZE 1
#define CSR_AD9361_AGC_COUNT_RX2_HIGH_CONTROL_ADDR (CSR_BASE + 0xc068L)
#define CSR_AD9361_AGC_COUNT_RX2_HIGH_CONTROL_SIZE 1
#define CSR_AD9361_AGC_COUNT_RX2_HIGH_STATUS_ADDR (CSR_BASE + 0xc06cL)
...
static inline uint64_t ad9361_scheduler_tx_current_ts_read(void) {
	uint64_t r = csr_read_simple((CSR_BASE + 0xc038L));
	r <<= 32;
	r |= csr_read_simple((CSR_BASE + 0xc03cL));
	return r;
}
static inline uint64_t ad9361_scheduler_tx_now_read(void) {
	uint64_t r = csr_read_simple((CSR_BASE + 0xc040L));
	r <<= 32;
	r |= csr_read_simple((CSR_BASE + 0xc044L));
	return r;
}
...
static inline void ad9361_agc_count_rx1_low_control_write(uint32_t v) {
	csr_write_simple(v, (CSR_BASE + 0xc050L));
}
...
static inline void ad9361_agc_count_rx1_high_control_write(uint32_t v) {
	csr_write_simple(v, (CSR_BASE + 0xc058L));
}
...
static inline void ad9361_agc_count_rx2_low_control_write(uint32_t v) {
	csr_write_simple(v, (CSR_BASE + 0xc060L));
}
...
static inline void ad9361_agc_count_rx2_high_control_write(uint32_t v) {
	csr_write_simple(v, (CSR_BASE + 0xc068L));
}
