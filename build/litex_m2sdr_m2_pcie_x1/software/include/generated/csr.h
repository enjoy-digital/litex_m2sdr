...
#define CSR_PCIE_ENDPOINT_BASE (CSR_BASE + 0xb000L)
#define CSR_PCIE_ENDPOINT_PHY_LINK_STATUS_ADDR (CSR_BASE + 0xb000L)
#define CSR_PCIE_ENDPOINT_PHY_LINK_STATUS_SIZE 1
#define CSR_PCIE_ENDPOINT_PHY_MSI_ENABLE_ADDR (CSR_BASE + 0xb004L)
#define CSR_PCIE_ENDPOINT_PHY_MSI_ENABLE_SIZE 1
#define CSR_PCIE_ENDPOINT_PHY_MSIX_ENABLE_ADDR (CSR_BASE + 0xb008L)
#define CSR_PCIE_ENDPOINT_PHY_MSIX_ENABLE_SIZE 1
#define CSR_PCIE_ENDPOINT_PHY_BUS_MASTER_ENABLE_ADDR (CSR_BASE + 0xb00cL)
#define CSR_PCIE_ENDPOINT_PHY_BUS_MASTER_ENABLE_SIZE 1
#define CSR_PCIE_ENDPOINT_PHY_MAX_REQUEST_SIZE_ADDR (CSR_BASE + 0xb010L)
#define CSR_PCIE_ENDPOINT_PHY_MAX_REQUEST_SIZE_SIZE 1
#define CSR_PCIE_ENDPOINT_PHY_MAX_PAYLOAD_SIZE_ADDR (CSR_BASE + 0xb014L)
...
#define CSR_AD9361_PRBS_TX_ADDR (CSR_BASE + 0xc024L)
#define CSR_AD9361_PRBS_TX_SIZE 1
#define CSR_AD9361_PRBS_RX_ADDR (CSR_BASE + 0xc028L)
#define CSR_AD9361_PRBS_RX_SIZE 1
#define CSR_AD9361_AGC_COUNT_RX1_LOW_CONTROL_ADDR (CSR_BASE + 0xc02cL)
#define CSR_AD9361_AGC_COUNT_RX1_LOW_CONTROL_SIZE 1
#define CSR_AD9361_AGC_COUNT_RX1_LOW_STATUS_ADDR (CSR_BASE + 0xc030L)
#define CSR_AD9361_AGC_COUNT_RX1_LOW_STATUS_SIZE 1
#define CSR_AD9361_AGC_COUNT_RX1_HIGH_CONTROL_ADDR (CSR_BASE + 0xc034L)
#define CSR_AD9361_AGC_COUNT_RX1_HIGH_CONTROL_SIZE 1
#define CSR_AD9361_AGC_COUNT_RX1_HIGH_STATUS_ADDR (CSR_BASE + 0xc038L)
#define CSR_AD9361_AGC_COUNT_RX1_HIGH_STATUS_SIZE 1
#define CSR_AD9361_AGC_COUNT_RX2_LOW_CONTROL_ADDR (CSR_BASE + 0xc03cL)
#define CSR_AD9361_AGC_COUNT_RX2_LOW_CONTROL_SIZE 1
#define CSR_AD9361_AGC_COUNT_RX2_LOW_STATUS_ADDR (CSR_BASE + 0xc040L)
#define CSR_AD9361_AGC_COUNT_RX2_LOW_STATUS_SIZE 1
#define CSR_AD9361_AGC_COUNT_RX2_HIGH_CONTROL_ADDR (CSR_BASE + 0xc044L)
#define CSR_AD9361_AGC_COUNT_RX2_HIGH_CONTROL_SIZE 1
#define CSR_AD9361_AGC_COUNT_RX2_HIGH_STATUS_ADDR (CSR_BASE + 0xc048L)
...
/* ANALYZER Registers */
#define CSR_ANALYZER_BASE (CSR_BASE + 0xf800L)
#define CSR_ANALYZER_MUX_VALUE_ADDR (CSR_BASE + 0xf800L)
#define CSR_ANALYZER_MUX_VALUE_SIZE 1
#define CSR_ANALYZER_TRIGGER_ENABLE_ADDR (CSR_BASE + 0xf804L)
#define CSR_ANALYZER_TRIGGER_ENABLE_SIZE 1
#define CSR_ANALYZER_TRIGGER_DONE_ADDR (CSR_BASE + 0xf808L)
#define CSR_ANALYZER_TRIGGER_DONE_SIZE 1
#define CSR_ANALYZER_TRIGGER_MEM_WRITE_ADDR (CSR_BASE + 0xf80cL)
#define CSR_ANALYZER_TRIGGER_MEM_WRITE_SIZE 1
#define CSR_ANALYZER_TRIGGER_MEM_MASK_ADDR (CSR_BASE + 0xf810L)
#define CSR_ANALYZER_TRIGGER_MEM_MASK_SIZE 1
#define CSR_ANALYZER_TRIGGER_MEM_VALUE_ADDR (CSR_BASE + 0xf814L)
#define CSR_ANALYZER_TRIGGER_MEM_VALUE_SIZE 1
#define CSR_ANALYZER_TRIGGER_MEM_FULL_ADDR (CSR_BASE + 0xf818L)
#define CSR_ANALYZER_TRIGGER_MEM_FULL_SIZE 1
#define CSR_ANALYZER_SUBSAMPLER_VALUE_ADDR (CSR_BASE + 0xf81cL)
#define CSR_ANALYZER_SUBSAMPLER_VALUE_SIZE 1
#define CSR_ANALYZER_STORAGE_ENABLE_ADDR (CSR_BASE + 0xf820L)
#define CSR_ANALYZER_STORAGE_ENABLE_SIZE 1
#define CSR_ANALYZER_STORAGE_DONE_ADDR (CSR_BASE + 0xf824L)
#define CSR_ANALYZER_STORAGE_DONE_SIZE 1
#define CSR_ANALYZER_STORAGE_LENGTH_ADDR (CSR_BASE + 0xf828L)
#define CSR_ANALYZER_STORAGE_LENGTH_SIZE 1
#define CSR_ANALYZER_STORAGE_OFFSET_ADDR (CSR_BASE + 0xf82cL)
#define CSR_ANALYZER_STORAGE_OFFSET_SIZE 1
#define CSR_ANALYZER_STORAGE_MEM_LEVEL_ADDR (CSR_BASE + 0xf830L)
#define CSR_ANALYZER_STORAGE_MEM_LEVEL_SIZE 1
#define CSR_ANALYZER_STORAGE_MEM_DATA_ADDR (CSR_BASE + 0xf834L)
...
static inline uint32_t pcie_endpoint_phy_bus_master_enable_read(void) {
	return csr_read_simple((CSR_BASE + 0xb00cL));
}
...
static inline void analyzer_trigger_enable_write(uint32_t v) {
	csr_write_simple(v, (CSR_BASE + 0xf804L));
}
...
static inline void analyzer_trigger_mem_write_write(uint32_t v) {
	csr_write_simple(v, (CSR_BASE + 0xf80cL));
}
...
static inline void analyzer_trigger_mem_mask_write(uint32_t v) {
	csr_write_simple(v, (CSR_BASE + 0xf810L));
}
