//--------------------------------------------------------------------------------
// Auto-generated by LiteX (d89f19e55) on 2025-10-15 19:04:45
//--------------------------------------------------------------------------------
...
#define CSR_AD9361_SCHEDULER_TX_RESET_ADDR (CSR_BASE + 0xc024L)
#define CSR_AD9361_SCHEDULER_TX_RESET_SIZE 1
#define CSR_AD9361_SCHEDULER_TX_MANUAL_NOW_ADDR (CSR_BASE + 0xc028L)
#define CSR_AD9361_SCHEDULER_TX_MANUAL_NOW_SIZE 2
#define CSR_AD9361_SCHEDULER_TX_SET_TS_ADDR (CSR_BASE + 0xc030L)
#define CSR_AD9361_SCHEDULER_TX_SET_TS_SIZE 1
#define CSR_AD9361_SCHEDULER_TX_FIFO_LEVEL_ADDR (CSR_BASE + 0xc034L)
#define CSR_AD9361_SCHEDULER_TX_FIFO_LEVEL_SIZE 1
#define CSR_AD9361_SCHEDULER_TX_FLAGS_ADDR (CSR_BASE + 0xc038L)
#define CSR_AD9361_SCHEDULER_TX_FLAGS_SIZE 1
#define CSR_AD9361_SCHEDULER_TX_CURRENT_TS_ADDR (CSR_BASE + 0xc03cL)
#define CSR_AD9361_SCHEDULER_TX_CURRENT_TS_SIZE 2
#define CSR_AD9361_SCHEDULER_TX_NOW_ADDR (CSR_BASE + 0xc044L)
...
static inline uint32_t ad9361_scheduler_tx_reset_read(void) {
	return csr_read_simple((CSR_BASE + 0xc024L));
}
static inline void ad9361_scheduler_tx_reset_write(uint32_t v) {
	csr_write_simple(v, (CSR_BASE + 0xc024L));
}
static inline uint64_t ad9361_scheduler_tx_manual_now_read(void) {
	uint64_t r = csr_read_simple((CSR_BASE + 0xc028L));
	r <<= 32;
	r |= csr_read_simple((CSR_BASE + 0xc02cL));
	return r;
}
static inline void ad9361_scheduler_tx_manual_now_write(uint64_t v) {
	csr_write_simple(v >> 32, (CSR_BASE + 0xc028L));
	csr_write_simple(v, (CSR_BASE + 0xc02cL));
}
static inline uint32_t ad9361_scheduler_tx_set_ts_read(void) {
	return csr_read_simple((CSR_BASE + 0xc030L));
}
static inline void ad9361_scheduler_tx_set_ts_write(uint32_t v) {
	csr_write_simple(v, (CSR_BASE + 0xc030L));
}
static inline uint32_t ad9361_scheduler_tx_fifo_level_read(void) {
	return csr_read_simple((CSR_BASE + 0xc034L));
}
static inline uint32_t ad9361_scheduler_tx_flags_read(void) {
...
static inline uint64_t ad9361_scheduler_tx_now_read(void) {
