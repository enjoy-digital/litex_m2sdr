//--------------------------------------------------------------------------------
// Auto-generated by LiteX (14dbdeb0) on 2024-05-21 12:41:29
//--------------------------------------------------------------------------------
...
/* CK0_MEASUREMENT Registers */
#define CSR_CK0_MEASUREMENT_BASE (CSR_BASE + 0x1000L)
#define CSR_CK0_MEASUREMENT_LATCH_ADDR (CSR_BASE + 0x1000L)
#define CSR_CK0_MEASUREMENT_LATCH_SIZE 1
#define CSR_CK0_MEASUREMENT_VALUE_ADDR (CSR_BASE + 0x1004L)
#define CSR_CK0_MEASUREMENT_VALUE_SIZE 2

/* CK0_MEASUREMENT Fields */

/* CLK1_MEASUREMENT Registers */
#define CSR_CLK1_MEASUREMENT_BASE (CSR_BASE + 0x1800L)
#define CSR_CLK1_MEASUREMENT_LATCH_ADDR (CSR_BASE + 0x1800L)
#define CSR_CLK1_MEASUREMENT_LATCH_SIZE 1
#define CSR_CLK1_MEASUREMENT_VALUE_ADDR (CSR_BASE + 0x1804L)
#define CSR_CLK1_MEASUREMENT_VALUE_SIZE 2

/* CLK1_MEASUREMENT Fields */

/* CLK2_MEASUREMENT Registers */
#define CSR_CLK2_MEASUREMENT_BASE (CSR_BASE + 0x2000L)
#define CSR_CLK2_MEASUREMENT_LATCH_ADDR (CSR_BASE + 0x2000L)
#define CSR_CLK2_MEASUREMENT_LATCH_SIZE 1
#define CSR_CLK2_MEASUREMENT_VALUE_ADDR (CSR_BASE + 0x2004L)
#define CSR_CLK2_MEASUREMENT_VALUE_SIZE 2

/* CLK2_MEASUREMENT Fields */

/* CLK3_MEASUREMENT Registers */
#define CSR_CLK3_MEASUREMENT_BASE (CSR_BASE + 0x2800L)
#define CSR_CLK3_MEASUREMENT_LATCH_ADDR (CSR_BASE + 0x2800L)
#define CSR_CLK3_MEASUREMENT_LATCH_SIZE 1
#define CSR_CLK3_MEASUREMENT_VALUE_ADDR (CSR_BASE + 0x2804L)
...
/* DNA Registers */
#define CSR_DNA_BASE (CSR_BASE + 0x3800L)
#define CSR_DNA_ID_ADDR (CSR_BASE + 0x3800L)
