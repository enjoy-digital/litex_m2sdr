//--------------------------------------------------------------------------------
// Auto-generated by LiteX (14dbdeb0) on 2024-05-23 13:31:47
//--------------------------------------------------------------------------------
...
/* AD9361 Registers */
#define CSR_AD9361_BASE 0x0L
#define CSR_AD9361_CONFIG_ADDR 0x0L
#define CSR_AD9361_CONFIG_SIZE 1
#define CSR_AD9361_CTRL_ADDR 0x4L
#define CSR_AD9361_CTRL_SIZE 1
#define CSR_AD9361_STAT_ADDR 0x8L
#define CSR_AD9361_STAT_SIZE 1
#define CSR_AD9361_PHY_CONTROL_ADDR 0xcL
#define CSR_AD9361_PHY_CONTROL_SIZE 1
#define CSR_AD9361_SPI_CONTROL_ADDR 0x10L
#define CSR_AD9361_SPI_CONTROL_SIZE 1
#define CSR_AD9361_SPI_STATUS_ADDR 0x14L
#define CSR_AD9361_SPI_STATUS_SIZE 1
#define CSR_AD9361_SPI_MOSI_ADDR 0x18L
#define CSR_AD9361_SPI_MOSI_SIZE 1
#define CSR_AD9361_SPI_MISO_ADDR 0x1cL
#define CSR_AD9361_SPI_MISO_SIZE 1
#define CSR_AD9361_PRBS_TX_ADDR 0x20L
#define CSR_AD9361_PRBS_TX_SIZE 1
#define CSR_AD9361_PRBS_RX_ADDR 0x24L
...
#define CSR_CLK0_MEASUREMENT_BASE 0x800L
#define CSR_CLK0_MEASUREMENT_LATCH_ADDR 0x800L
#define CSR_CLK0_MEASUREMENT_LATCH_SIZE 1
#define CSR_CLK0_MEASUREMENT_VALUE_ADDR 0x804L
#define CSR_CLK0_MEASUREMENT_VALUE_SIZE 2

/* CLK0_MEASUREMENT Fields */

/* CLK1_MEASUREMENT Registers */
#define CSR_CLK1_MEASUREMENT_BASE 0x1000L
#define CSR_CLK1_MEASUREMENT_LATCH_ADDR 0x1000L
#define CSR_CLK1_MEASUREMENT_LATCH_SIZE 1
#define CSR_CLK1_MEASUREMENT_VALUE_ADDR 0x1004L
#define CSR_CLK1_MEASUREMENT_VALUE_SIZE 2

/* CLK1_MEASUREMENT Fields */

/* CLK2_MEASUREMENT Registers */
#define CSR_CLK2_MEASUREMENT_BASE 0x1800L
#define CSR_CLK2_MEASUREMENT_LATCH_ADDR 0x1800L
#define CSR_CLK2_MEASUREMENT_LATCH_SIZE 1
#define CSR_CLK2_MEASUREMENT_VALUE_ADDR 0x1804L
#define CSR_CLK2_MEASUREMENT_VALUE_SIZE 2

/* CLK2_MEASUREMENT Fields */

/* CLK3_MEASUREMENT Registers */
#define CSR_CLK3_MEASUREMENT_BASE 0x2000L
#define CSR_CLK3_MEASUREMENT_LATCH_ADDR 0x2000L
#define CSR_CLK3_MEASUREMENT_LATCH_SIZE 1
#define CSR_CLK3_MEASUREMENT_VALUE_ADDR 0x2004L
#define CSR_CLK3_MEASUREMENT_VALUE_SIZE 2

/* CLK3_MEASUREMENT Fields */

/* CTRL Registers */
#define CSR_CTRL_BASE 0x2800L
#define CSR_CTRL_RESET_ADDR 0x2800L
#define CSR_CTRL_RESET_SIZE 1
#define CSR_CTRL_SCRATCH_ADDR 0x2804L
#define CSR_CTRL_SCRATCH_SIZE 1
#define CSR_CTRL_BUS_ERRORS_ADDR 0x2808L
...
/* DNA Registers */
#define CSR_DNA_BASE 0x3000L
#define CSR_DNA_ID_ADDR 0x3000L
#define CSR_DNA_ID_SIZE 2

/* DNA Fields */

/* HEADER Registers */
#define CSR_HEADER_BASE 0x3800L
#define CSR_HEADER_TX_CONTROL_ADDR 0x3800L
#define CSR_HEADER_TX_CONTROL_SIZE 1
#define CSR_HEADER_TX_FRAME_CYCLES_ADDR 0x3804L
#define CSR_HEADER_TX_FRAME_CYCLES_SIZE 1
#define CSR_HEADER_RX_CONTROL_ADDR 0x3808L
#define CSR_HEADER_RX_CONTROL_SIZE 1
#define CSR_HEADER_RX_FRAME_CYCLES_ADDR 0x380cL
#define CSR_HEADER_RX_FRAME_CYCLES_SIZE 1
#define CSR_HEADER_LAST_TX_HEADER_ADDR 0x3810L
#define CSR_HEADER_LAST_TX_HEADER_SIZE 2
#define CSR_HEADER_LAST_TX_TIMESTAMP_ADDR 0x3818L
#define CSR_HEADER_LAST_TX_TIMESTAMP_SIZE 2
#define CSR_HEADER_LAST_RX_HEADER_ADDR 0x3820L
#define CSR_HEADER_LAST_RX_HEADER_SIZE 2
#define CSR_HEADER_LAST_RX_TIMESTAMP_ADDR 0x3828L
...
/* ICAP Registers */
#define CSR_ICAP_BASE 0x4000L
#define CSR_ICAP_ADDR_ADDR 0x4000L
#define CSR_ICAP_ADDR_SIZE 1
#define CSR_ICAP_DATA_ADDR 0x4004L
#define CSR_ICAP_DATA_SIZE 1
#define CSR_ICAP_WRITE_ADDR 0x4008L
#define CSR_ICAP_WRITE_SIZE 1
#define CSR_ICAP_DONE_ADDR 0x400cL
#define CSR_ICAP_DONE_SIZE 1
#define CSR_ICAP_READ_ADDR 0x4010L
#define CSR_ICAP_READ_SIZE 1

/* ICAP Fields */

/* IDENTIFIER_MEM Registers */
#define CSR_IDENTIFIER_MEM_BASE 0x4800L

/* IDENTIFIER_MEM Fields */

/* LEDS Registers */
#define CSR_LEDS_BASE 0x5000L
#define CSR_LEDS_OUT_ADDR 0x5000L
#define CSR_LEDS_OUT_SIZE 1

/* LEDS Fields */

/* PCIE_DMA0 Registers */
#define CSR_PCIE_DMA0_BASE 0x5800L
#define CSR_PCIE_DMA0_WRITER_ENABLE_ADDR 0x5800L
#define CSR_PCIE_DMA0_WRITER_ENABLE_SIZE 1
#define CSR_PCIE_DMA0_WRITER_TABLE_VALUE_ADDR 0x5804L
#define CSR_PCIE_DMA0_WRITER_TABLE_VALUE_SIZE 2
#define CSR_PCIE_DMA0_WRITER_TABLE_WE_ADDR 0x580cL
#define CSR_PCIE_DMA0_WRITER_TABLE_WE_SIZE 1
#define CSR_PCIE_DMA0_WRITER_TABLE_LOOP_PROG_N_ADDR 0x5810L
#define CSR_PCIE_DMA0_WRITER_TABLE_LOOP_PROG_N_SIZE 1
#define CSR_PCIE_DMA0_WRITER_TABLE_LOOP_STATUS_ADDR 0x5814L
#define CSR_PCIE_DMA0_WRITER_TABLE_LOOP_STATUS_SIZE 1
#define CSR_PCIE_DMA0_WRITER_TABLE_LEVEL_ADDR 0x5818L
#define CSR_PCIE_DMA0_WRITER_TABLE_LEVEL_SIZE 1
#define CSR_PCIE_DMA0_WRITER_TABLE_RESET_ADDR 0x581cL
#define CSR_PCIE_DMA0_WRITER_TABLE_RESET_SIZE 1
#define CSR_PCIE_DMA0_READER_ENABLE_ADDR 0x5820L
#define CSR_PCIE_DMA0_READER_ENABLE_SIZE 1
#define CSR_PCIE_DMA0_READER_TABLE_VALUE_ADDR 0x5824L
#define CSR_PCIE_DMA0_READER_TABLE_VALUE_SIZE 2
#define CSR_PCIE_DMA0_READER_TABLE_WE_ADDR 0x582cL
#define CSR_PCIE_DMA0_READER_TABLE_WE_SIZE 1
#define CSR_PCIE_DMA0_READER_TABLE_LOOP_PROG_N_ADDR 0x5830L
#define CSR_PCIE_DMA0_READER_TABLE_LOOP_PROG_N_SIZE 1
#define CSR_PCIE_DMA0_READER_TABLE_LOOP_STATUS_ADDR 0x5834L
#define CSR_PCIE_DMA0_READER_TABLE_LOOP_STATUS_SIZE 1
#define CSR_PCIE_DMA0_READER_TABLE_LEVEL_ADDR 0x5838L
#define CSR_PCIE_DMA0_READER_TABLE_LEVEL_SIZE 1
#define CSR_PCIE_DMA0_READER_TABLE_RESET_ADDR 0x583cL
#define CSR_PCIE_DMA0_READER_TABLE_RESET_SIZE 1
#define CSR_PCIE_DMA0_LOOPBACK_ENABLE_ADDR 0x5840L
#define CSR_PCIE_DMA0_LOOPBACK_ENABLE_SIZE 1
#define CSR_PCIE_DMA0_SYNCHRONIZER_BYPASS_ADDR 0x5844L
#define CSR_PCIE_DMA0_SYNCHRONIZER_BYPASS_SIZE 1
#define CSR_PCIE_DMA0_SYNCHRONIZER_ENABLE_ADDR 0x5848L
#define CSR_PCIE_DMA0_SYNCHRONIZER_ENABLE_SIZE 1
#define CSR_PCIE_DMA0_BUFFERING_READER_FIFO_CONTROL_ADDR 0x584cL
#define CSR_PCIE_DMA0_BUFFERING_READER_FIFO_CONTROL_SIZE 1
#define CSR_PCIE_DMA0_BUFFERING_READER_FIFO_STATUS_ADDR 0x5850L
#define CSR_PCIE_DMA0_BUFFERING_READER_FIFO_STATUS_SIZE 1
#define CSR_PCIE_DMA0_BUFFERING_WRITER_FIFO_CONTROL_ADDR 0x5854L
#define CSR_PCIE_DMA0_BUFFERING_WRITER_FIFO_CONTROL_SIZE 1
#define CSR_PCIE_DMA0_BUFFERING_WRITER_FIFO_STATUS_ADDR 0x5858L
...
#define CSR_PCIE_ENDPOINT_BASE 0x6000L
#define CSR_PCIE_ENDPOINT_PHY_LINK_STATUS_ADDR 0x6000L
#define CSR_PCIE_ENDPOINT_PHY_LINK_STATUS_SIZE 1
#define CSR_PCIE_ENDPOINT_PHY_MSI_ENABLE_ADDR 0x6004L
#define CSR_PCIE_ENDPOINT_PHY_MSI_ENABLE_SIZE 1
#define CSR_PCIE_ENDPOINT_PHY_MSIX_ENABLE_ADDR 0x6008L
#define CSR_PCIE_ENDPOINT_PHY_MSIX_ENABLE_SIZE 1
#define CSR_PCIE_ENDPOINT_PHY_BUS_MASTER_ENABLE_ADDR 0x600cL
#define CSR_PCIE_ENDPOINT_PHY_BUS_MASTER_ENABLE_SIZE 1
#define CSR_PCIE_ENDPOINT_PHY_MAX_REQUEST_SIZE_ADDR 0x6010L
#define CSR_PCIE_ENDPOINT_PHY_MAX_REQUEST_SIZE_SIZE 1
#define CSR_PCIE_ENDPOINT_PHY_MAX_PAYLOAD_SIZE_ADDR 0x6014L
...
/* PCIE_MSI Registers */
#define CSR_PCIE_MSI_BASE 0x6800L
#define CSR_PCIE_MSI_ENABLE_ADDR 0x6800L
#define CSR_PCIE_MSI_ENABLE_SIZE 1
#define CSR_PCIE_MSI_CLEAR_ADDR 0x6804L
#define CSR_PCIE_MSI_CLEAR_SIZE 1
#define CSR_PCIE_MSI_VECTOR_ADDR 0x6808L
#define CSR_PCIE_MSI_VECTOR_SIZE 1

/* PCIE_MSI Fields */

/* PCIE_PHY Registers */
#define CSR_PCIE_PHY_BASE 0x7000L
#define CSR_PCIE_PHY_PHY_LINK_STATUS_ADDR 0x7000L
#define CSR_PCIE_PHY_PHY_LINK_STATUS_SIZE 1
#define CSR_PCIE_PHY_PHY_MSI_ENABLE_ADDR 0x7004L
#define CSR_PCIE_PHY_PHY_MSI_ENABLE_SIZE 1
#define CSR_PCIE_PHY_PHY_MSIX_ENABLE_ADDR 0x7008L
#define CSR_PCIE_PHY_PHY_MSIX_ENABLE_SIZE 1
#define CSR_PCIE_PHY_PHY_BUS_MASTER_ENABLE_ADDR 0x700cL
#define CSR_PCIE_PHY_PHY_BUS_MASTER_ENABLE_SIZE 1
#define CSR_PCIE_PHY_PHY_MAX_REQUEST_SIZE_ADDR 0x7010L
#define CSR_PCIE_PHY_PHY_MAX_REQUEST_SIZE_SIZE 1
#define CSR_PCIE_PHY_PHY_MAX_PAYLOAD_SIZE_ADDR 0x7014L
...
#define CSR_SI5351_I2C_BASE 0x7800L
#define CSR_SI5351_I2C_W_ADDR 0x7800L
#define CSR_SI5351_I2C_W_SIZE 1
#define CSR_SI5351_I2C_R_ADDR 0x7804L
...
#define CSR_SI5351_PWM_BASE 0x8000L
#define CSR_SI5351_PWM_ENABLE_ADDR 0x8000L
#define CSR_SI5351_PWM_ENABLE_SIZE 1
#define CSR_SI5351_PWM_WIDTH_ADDR 0x8004L
#define CSR_SI5351_PWM_WIDTH_SIZE 1
#define CSR_SI5351_PWM_PERIOD_ADDR 0x8008L
#define CSR_SI5351_PWM_PERIOD_SIZE 1

/* SI5351_PWM Fields */

/* XADC Registers */
#define CSR_XADC_BASE 0x8800L
#define CSR_XADC_TEMPERATURE_ADDR 0x8800L
#define CSR_XADC_TEMPERATURE_SIZE 1
#define CSR_XADC_VCCINT_ADDR 0x8804L
#define CSR_XADC_VCCINT_SIZE 1
#define CSR_XADC_VCCAUX_ADDR 0x8808L
#define CSR_XADC_VCCAUX_SIZE 1
#define CSR_XADC_VCCBRAM_ADDR 0x880cL
#define CSR_XADC_VCCBRAM_SIZE 1
#define CSR_XADC_EOC_ADDR 0x8810L
#define CSR_XADC_EOC_SIZE 1
#define CSR_XADC_EOS_ADDR 0x8814L
