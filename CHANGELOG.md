...
- Added an optional native `m2sdr_lab_gui` cimgui/SDL/OpenGL dashboard to browse RF-lab runs, reports, measurement artifacts, verification results, and sweep outputs.
