...
- Defaulted Ethernet-enabled builds, including the baseboard PCIe x1 + Ethernet image, to a 100MHz system clock for release timing margin while keeping PCIe-only M.2 images at 125MHz.
