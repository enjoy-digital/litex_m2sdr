...
- `-refclk_freq hz` AD9361 reference clock generated by SI5351 (typically `38400000` or `40000000`)
  With `-sync external`, the SI5351 input is an external `10MHz` CLKIN (UFL), but `-refclk_freq` remains the generated AD9361 RefClk.
