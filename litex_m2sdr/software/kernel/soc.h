...
#define SATA_MEM2SECTOR_INTERRUPT 2
#define SATA_SECT2STREAM_INTERRUPT 3
#define SATA_SECTOR2MEM_INTERRUPT 4
#define SATA_STREAM2SECT_INTERRUPT 5
#define CONFIG_CPU_HAS_DMA_BUS
#define CONFIG_CLOCK_FREQUENCY 125000000
#define CONFIG_IDENTIFIER "LiteX-M2SDR SoC / CSR reference (union of the supported build configurations)"
